...
<dl class="dlTable">
    <dt><label for="cname">相談者のお名前</label></dt>
	  <dd><?php echo h($cname);?></dd>
    <dt><label for="cage">相談者の年齢</label></dt>
	  <dd><?php echo h($cage,ENT_QUOTES,'UTF-8');?></dd>
    <dt><label for="ctel">相談者の電話番号</label></dt>
	  <dd><?php echo htmlspecialchars($ctel,ENT_QUOTES,'UTF-8');?></dd>
    <dt><label for="cmail">相談者のメールアドレス</label></dt>
	  <dd><?php echo htmlspecialchars($cmail,ENT_QUOTES,'UTF-8');?></dd>
    <dt><label for="cway">希望する連絡手段</label></dt>
	  <dd><?php echo htmlspecialchars($cway,ENT_QUOTES,'UTF-8');?></dd>
